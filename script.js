...
// Category tabs functionality (for attractions page)
...
if (categoryTabs.length > 0) {
    categoryTabs.forEach(tab => {
        tab.addEventListener('click', () => {
            ...
            // In a real implementation, this would filter the attractions
            // For this static site, it's just visual feedback
        });
    });
}
...
if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            submitBtn.innerHTML = '<span>נשלח בהצלחה!</span><i class="fas fa-check"></i>';
            ...
            // Show error message
            submitBtn.innerHTML = '<span>שגיאה, נסו שוב</span><i class="fas fa-exclamation-triangle"></i>';
...
document.querySelectorAll('.benefit-card, .value-card, .team-member-card, .testimonial-card, .attraction-card-enhanced').forEach(el => {
...
console.log('Paris Guide - Website initialized successfully! 🗼✨');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Paris Guide משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '4510f8c3-3cd9-42c4-9678-8ee2abb84fee',
                    name: data.name || '',
                    email: data.email || '',
